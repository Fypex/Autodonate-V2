...
<head>
    <meta charset="UTF-8">
    <title><?php echo $_ENV['ST_NAME'] ?> - Успешная оплата</title>
...
<body style="background: #4CAF50;min-height: 100vh;overflow-y: hidden">
    <h1 style="color: white;padding-top: 40vh">Успешная оплата!</h1>
    <script>
